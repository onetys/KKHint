...
open class KKHint: NSObject {
	...
	/// 默认展示的时间
	public static let SMMBDurationDefault: SMMBDuration    = 2.0
	
	/// 一直展示的时间
	public static let SMMBDurationForever: SMMBDuration    = -1
	
	/// 距离父视图底部距离失效，不起作用
	public static let SMMBSuperBottomInvalid: SMMBSuperBottom = -1
	
	/// 距离父视图底部顶离失效，不起作用
	public static let SMMBSuperTopInvalid: SMMBSuperTop    = -1
